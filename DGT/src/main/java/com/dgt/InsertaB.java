 ...
 * @author david
 */
public class InsertaB extends javax.swing.JFrame {
    ...
    private void btnInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertarActionPerformed
       ...
       File fichero = new File("C:\\Archivos\\mediadgt\\traficoB.csv");
        try {
            ...
            Logger.getLogger(InsertaB.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertaB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
